...
% User definition
I_test_1_rgb = imread(sprintf('Testing_Images/Face_3.jpg'));
I_test_1 = rgb2gray(imread(sprintf('Testing_Images/Face_3.jpg')));
...
for i = 1 : length(I_scale)
    ...
    tic;
    [face_positions, face_scores] = detect_face(I_test, filter_H, param_H, alpha_H, threshold);
...
% save('I_test_3_HN.mat', 'face_positions_merge', 'face_scores_merge', 'face_positions_merge_unified', 'bounding_boxes', 'bounding_boxes_scores');
...
%% ============= Helper functions =============
function [face_positions, face_scores] = detect_face(I, filter_H, param_H, alpha_H, threshold)
