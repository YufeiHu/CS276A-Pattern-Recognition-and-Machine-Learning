function [error_1000, optimal_filter_error, optimal_filter_index, optimal_filter_params] = compute_errors(Y, features, w)
    ...
    parfor i = 1 : N_filters
        ...
        [error, theta, s] = compute_errors_helper(feature_single, s_pool, theta_pool, w', Y');
